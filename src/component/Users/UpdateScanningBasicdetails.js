                ...
                <div className='rec_user'>
                    ...
                    <form >
                        ...
                        <div className="form-group ">
                            ...
                            <input type="text" className="form-control" id='startreading' disabled value={data.Requestid} />  
                         </div>

                            <div className="form-group">
                                <label> Date</label>
                                <input type="text" className="form-control" id='startreading' disabled value={data.ARRIVEDDATE} />  
                            </div>
                          

                         <div className="form-group">
                            <label>Select Scanner Type</label>
                            <input type="text" className="form-control" id='startreading' disabled value={data.Assetname} />  
                         </div>

                        <div className="form-row">
                            <div className="form-group col-md-6">
                                <label> Scanner start reading</label>
                                <input type="number" className="form-control" id='startreading' disabled value={data.StartReading} />  
                            </div>
                            <div className="form-group col-md-6">
                        ...
                        <div className="form-group" >
                            <button type="submit" className="dark_btn btn float-right mb-4" onClick={handleClick}>Update</button>
